package onlineshoppingportal.controller;
...
public class AdminController {
	...
	/*
	 * @Autowired private ProductInfoValidator productInfoValidator;
	 */
	...
	/*
	 * @InitBinder public void myInitBinder(WebDataBinder dataBinder) { Object
	 * target = dataBinder.getTarget(); if (target == null) { return; }
	 * System.out.println("Target=" + target);
	 * 
	 * if (target.getClass() == ProductInfo.class) {
	 * dataBinder.setValidator(productInfoValidator); // For upload Image.
